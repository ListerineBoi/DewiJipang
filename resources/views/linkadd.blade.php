        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('inputaddL')}}" enctype='multipart/form-data'>
                    <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">

                        

                            <div class="form-group">
                                <label for="formGroupExampleInput">Nama link</label>
                        ...
                        <div class="container">
                            <table class="table table-hover" style="text-align: center;">
                               ...
                               <tr>
                                ...
                                <form method="post" action="{{route('linkdeleteL')}}">
                                        @csrf
