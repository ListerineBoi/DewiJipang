...
<div class="col-12 kipas py-5  ">
    <h1 class="section-heading text-center display-4 custitle finger font-weight-bolder">Carousel</h1>
</div>
    ...
    <div class="row justify-content-center ">
        <div class="col-sm-10">
            ...
            <div class="card my-3" >
                ...
                <div class="col-sm-7">
                    <div class="card-body">
                    <h5 class="card-title mt-5">Home Wisata Edukasi</h5>
                    </div>
                </div>
                <div class="col-2 mt-5 text-right">
                <a href="/carousel_list/2/" role="button" class="btn btn-primary btn-lg">Lihat Detail</a>
                </div>
                </div>
            </div>
            ...
            <div class="card my-3" >
                ...
                <div class="col-sm-7">
                    <div class="card-body">
                    <h5 class="card-title mt-5">Home Kerajinan</h5>
                    </div>
                </div>
                <div class="col-2 mt-5 text-right">
                <a href="/carousel_list/3/" role="button" class="btn btn-primary btn-lg">Lihat Detail</a>
                </div>
                </div>
            </div>
        ...
        @foreach($homestay as $row)
            <div class="card my-3" >
                ...
                <div class="col-2 mt-5 text-right">
                <a href="/carousel_list/0/{{$row['id']}}" role="button" class="btn btn-primary btn-lg">Lihat Detail</a>
                </div>
                </div>
            </div>
        @endforeach
